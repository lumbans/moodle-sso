...
LABEL com.vmware.cp.artifact.flavor="sha256:c50c90cfd9d12b445b011e6ad529f1ad3daea45c26d20b00732fae3cd71f6a83" \
      ...
      org.opencontainers.image.created="2024-09-05T00:19:58Z" \
      ...
      org.opencontainers.image.ref.name="4.4.3-debian-12-r1" \
...
RUN mkdir -p /tmp/bitnami/pkg/cache/ ; cd /tmp/bitnami/pkg/cache/ ; \
    COMPONENTS=( \
      ...
      "libphp-8.1.29-5-linux-${OS_ARCH}-debian-12" \
      "moodle-4.4.3-0-linux-${OS_ARCH}-debian-12" \
    ) ; \
...
RUN curl -O https://moodle.org/plugins/download.php/32635/auth_oidc_moodle44_2024042200.zip && \
    unzip auth_oidc_moodle44_2024042200.zip -d /opt/bitnami/moodle/auth/ && rm -rf auth_oidc_moodle44_2024042200.zip
